...
function checkAllVolumes(clickedButtonNumber) {
    ...
    if (instruments[clickedButtonNumber].volume.value >= 0) {
        ...
        $("#stem"+clickedButtonNumber).css({"background-color":"red"});
        ...
        $("#stem"+clickedButtonNumber).css({"background-color":"green"});
...
function PauseStem(videoID){
    ...
    $("#"+videoID).get(0).pause();
    console.log(videoID);
     // $("#"+videoID).addClass("gray");
    // $("#"+videoID).css('color', 'red', 'important')
